      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => set("minStockThreshold", parseInt(e.target.value))}
            required
          />
        </div>
        <div>
  ...
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="sf-card p-3 flex flex-wrap gap-3">
        ...
        <select
          className="sf-input py-1.5 text-xs w-auto min-w-[140px]"
        ...
        <select
          className="sf-input py-1.5 text-xs w-auto min-w-[120px]"
