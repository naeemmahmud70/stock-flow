                  ...
                  {dateLogs.map((log, i) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center mt-0.5">
                        <div
                          className={`w-7 h-7 rounded-lg flex items-center justify-center shrink-0 ${ENTITY_COLORS[log.entity] ?? "bg-slate-100 text-slate-500"}`}
                        >
                          ...
                          Object.keys(log.metadata).length > 0 && (
                            <div className="mt-1.5 flex flex-wrap gap-1.5">
                              {Object.entries(log.metadata).map(([k, v]) => (
                                <span
                                  key={k}
                                  className="inline-flex items-center gap-1 px-2 py-0.5 bg-slate-100 rounded-md text-[10px] text-slate-500"
                                >
